...
//////////////////////////////////////////////////////////////////////////
// ATestNiagaraCharacter

ATestNiagaraCharacter::ATestNiagaraCharacter()
{
...
void ATestNiagaraCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ATestNiagaraCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ATestNiagaraCharacter::Look);
	}
	else
	{
...
void ATestNiagaraCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ATestNiagaraCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
